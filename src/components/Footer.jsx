      ...
      <div className="container-soft grid gap-10 py-10 md:grid-cols-[1.3fr_1fr_0.8fr_1.1fr]">
        ...
        <div>
          ...
          <div className="mt-4 flex gap-3">
            <a href="https://www.instagram.com/" className="grid h-10 w-10 place-items-center rounded-full border border-cocoa/30 text-cocoa transition hover:bg-card" aria-label="Instagram">
              <Instagram size={18} />
            </a>
            <a href="https://www.facebook.com/" className="grid h-10 w-10 place-items-center rounded-full border border-cocoa/30 text-cocoa transition hover:bg-card" aria-label="Facebook">
              <Facebook size={18} />
            </a>
          </div>
