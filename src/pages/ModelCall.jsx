...
export default function ModelCall() {
  return (
    <>
      <SEO
        title="Model gezocht"
        description="Model gezocht voor portfolio-uitbreiding bij Cuddling Memories Fotografie met 50% korting op geselecteerde shoots."
      />
      <section className="pt-36">
        <div className="container-soft grid items-center gap-10 pb-16 lg:grid-cols-[1fr_0.95fr]">
          <div>
            ...
            <p className="mt-6 text-lg leading-9 text-coffee/78">
              Voor het uitbreiden van mijn portfolio ben ik regelmatig op zoek naar modellen. Je mag dan met 50% korting
              bij mij komen shooten.
            </p>
            ...
            <Button to="/contact?shoot=Model%20staan%20met%2050%25%20korting" className="mt-9">
              Ik wil model staan
            </Button>
          </div>
            ...
            <div className="absolute -bottom-6 left-6 right-6 rounded-lg bg-card p-5 shadow-soft warm-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="display-title text-2xl font-semibold text-coffee">50% portfolio-modelplek</p>
                </div>
