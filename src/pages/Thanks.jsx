...
export default function Thanks() {
  return (
    <>
      <SEO title="Bedankt" description="Bedankt voor je aanvraag bij Cuddling Memories Fotografie. Demy neemt contact met je op." />
      <section className="min-h-[70vh] pt-36">
        <div className="container-soft pb-16">
          <div className="mx-auto max-w-2xl rounded-lg bg-card p-8 text-center shadow-soft warm-border md:p-12">
            ...
            <p className="mt-5 text-sm leading-7 text-coffee/75">Demy leest je bericht en reageert zo snel mogelijk met de volgende stap voor jouw shoot.</p>
