...
export default function Process() {
  return (
    <>
      <SEO
        title="Werkwijze"
        description="Lees hoe een fotoshoot bij Cuddling Memories verloopt, van aanvraag tot online galerij en favoriete beelden kiezen."
      />
        ...
        <div className="container-soft pb-16">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {steps.map(([title, Icon], index) => (
              <article key={title} className="rounded-lg bg-card p-7 shadow-soft warm-border">
                ...
                <h3 className="mt-7 display-title text-2xl font-semibold text-coffee">{title}</h3>
                <p className="mt-3 text-sm leading-7 text-coffee/72">
                  Elke stap is bedoeld om de shoot overzichtelijk en ontspannen te laten verlopen.
                </p>
                {title === "Online galerij ontvangen" && (
