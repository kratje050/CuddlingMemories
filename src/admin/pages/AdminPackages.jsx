...
const fields = [
  ...
  { name: "slug", label: "Slug", type: "text", required: true, help: "Technische URL-/koppelnaam. Gebruik kleine letters en streepjes, bijvoorbeeld newborn-basis." },
  ...
  { name: "price_unit", label: "Eenheid", type: "select", options: ["shoot", "item", "km"], required: true, help: "Geeft aan of de prijs per shoot, per extra item of per kilometer geldt." },
  ...
  { name: "button_text", label: "Knoptekst", type: "text", help: "Tekst op de knop bij dit pakket. Bijvoorbeeld Boek deze shoot." },
  { name: "sort_order", label: "Sortering", type: "number", help: "Lager getal komt eerder op de pakkettenpagina." },
  { name: "is_featured", label: "Uitgelicht", type: "checkbox", help: "Markeert dit pakket als aanrader of veelgekozen optie." },
  { name: "is_published", label: "Gepubliceerd", type: "checkbox", help: "Alleen gepubliceerde pakketten zijn zichtbaar voor bezoekers en in de boekingsflow." },
];
