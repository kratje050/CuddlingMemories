-- Cuddling Memories Fotografie — cadeaubon-korting zichtbaar in de mails
-- Voer dit één keer uit in de Supabase SQL Editor.

-- ---------------------------------------------------------------------------
-- book_slot(): geeft nu ook giftcard_amount/giftcard_type/giftcard_code mee
-- terug in het resultaat wanneer er een cadeaubon verzilverd is, zodat
-- create-booking.ts dit direct in de bevestigingsmails kan verwerken.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- booking_received-template: voegt een plek toe waar de cadeaubon-korting
-- (indien van toepassing) automatisch aan de klantmail wordt toegevoegd.
-- ---------------------------------------------------------------------------
...
where template_key = 'booking_received';
