      ...
      <section className="pt-36">
        <div className="container-soft grid gap-10 pb-16 lg:grid-cols-[0.85fr_1.15fr]">
          <div>
            ...
            <img src="/images/test-detail.svg" alt="Testafbeelding zachte newborn fotografie" className="mt-8 aspect-[4/3] w-full rounded-lg object-cover shadow-soft warm-border" />
          </div>
          ...
          >
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <label className="flex gap-3 rounded-lg bg-linen/70 p-4 text-sm leading-6 text-coffee/78 md:col-span-2">
                ...
                Ik ga akkoord met de privacyverklaring en geef toestemming om mijn aanvraag te beantwoorden.
              </label>
            </div>
            {status === "error" && (
