...
('Is een shoot op locatie bij de pakketprijs inbegrepen?', 'Ja. Een afspraak op locatie is inbegrepen in de pakketprijs; er worden hiervoor geen losse kosten toegevoegd.', 'Locatie', true, 4),
('Wat zit er in een pakket?', 'Per pakket staat vermeld hoeveel digitale beelden zijn inbegrepen en wat de vanaf-prijs is. Extra beelden komen er alleen bij als je na de shoot zelf meer foto''s kiest dan in het pakket zijn inbegrepen.', 'Pakketten', true, 5),
...
('Kan ik extra beelden als losse shoot boeken?', 'Nee, extra beelden zijn geen losse shoot. Je kunt ze na de shoot vanuit jouw online galerij bijbestellen.', 'Pakketten', true, 7),
